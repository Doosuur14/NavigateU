...
extension AlertManager {
    ...
    func showInvalidAlert(viewCon: UIViewController) {
        self.showAlert(viewController: viewCon, title: "INVALID EMAIL AND PASSWORD", message: "Please enter a valid email and password")
    }
    // MARK: Registration failed
    func showRegistrationFailedAlert(viewCon: UIViewController) {
        self.showAlert(viewController: viewCon, title: "REGISTRATION WAS NOT SUCCESSFUL", message: "Please review the details for the form")
    }
